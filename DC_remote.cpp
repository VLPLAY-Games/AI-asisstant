...
//     std::string& statusMessage, bool& delayExecution) {
...
//         return true;
//     } else if (command == "open control panel") {
//         std::cout << "[WARNING] Control Panel is not available on Linux." \
//             << std::endl;
...
//                     std::cout << "[PROMPT] Connecting from new IP: " \
//                         << senderIp << ". Allow? (y/n): ";
//                     char choice;
//                     std::cin >> choice;
//                     if (choice == 'y' || choice == 'Y') {
//                         addTrustedIp(senderIp);
//                         std::cout << "[INFO] Added trusted IP: " \
//                             << senderIp << "\n";
//                         std::string success = "SUCCESS: Connection accepted";
//                         send(clientSock, success.c_str(), \
//                             static_cast<int>(success.length()), 0);
//                     } else {
//                         std::string denied = "FAIL: IP not trusted.";
//                         std::cout << "[INFO] Connection refused from: " \
//                             << senderIp << "\n";
//                         send(clientSock, denied.c_str(), \
//                             static_cast<int>(denied.length()), 0);
//                         goto cleanup;
//                     }
//                 } else {
//                     std::string success = "SUCCESS: Connection accepted";
...
//                 std::string response = (success ? "SUCCESS: " : \
//                     "FAIL: ") + status;
